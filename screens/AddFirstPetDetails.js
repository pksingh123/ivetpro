...
export default class AddFirstPetDetails extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            petid: '',
            uid: '',
            name: this.props.navigation.getParam('pet_name') ? this.props.navigation.getParam('pet_name') : '',
            species: '',
            breed: '',
            sex: '',
            dob: '',
            ...
            RNFetchBlob.fetch('POST', 'https://videowithmyvet.com/webservices/add-pet.php', {
                ...
                .then((responseJson) => {
                    ...
                    if (responseJson.status === 'ok') {
                        ...
                        this.props.navigation.push('AddAnotherPet', { petName: this.state.name, petId: responseJson.lastid });
                        this.setState({ data: null, name: '', species: '', breed: '', sex: '', currentWeight: '', dob: '', practiceCode: '' })
                    } else {
